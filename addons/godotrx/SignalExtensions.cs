...
namespace GodotRx {
  public static class SignalExtensions {
    ...
    public static IObservable<(string[] Properties, Godot.Collections.Array Value)> OnMultiplePropertiesChanged(this Godot.EditorProperty obj)
      => obj.ObserveSignal<string[], Godot.Collections.Array>("multiple_properties_changed");
  ...
  public static class InputSignals {
    public static IObservable<(int Device, bool Connected)> OnJoyConnectionChanged()
      => Input.Singleton.ObserveSignal<int, bool>("joy_connection_changed");
  }

  public static class AudioServerSignals {
    public static IObservable<Unit> OnBusLayoutChanged()
      => AudioServer.Singleton.ObserveSignal("bus_layout_changed");
  }
  ...
  public static class CameraServerSignals {
    public static IObservable<int> OnCameraFeedRemoved()
      => CameraServer.Singleton.ObserveSignal<int>("camera_feed_removed");
